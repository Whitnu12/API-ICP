...
<body>
    <div id="alert-1" class="fixed w-full  inset-auto z-50 flex p-4 mb-4 text-white  bg-red-500 invisible" role="alert">
    ...
    <div class="h-screen md:flex">
        <div class="relative overflow-hidden md:flex w-1/2 bg-gradient-to-tr from-green-800 to-green-400 i justify-around items-center hidden">
            <div>
        ...
        <div class="flex md:w-1/2 justify-center py-10 items-center bg-white">
            <form class="bg-white" id="loginForm"  action="{{ route('admin.login') }}" onsubmit="event.preventDefault(); loginUser(this);">
                @csrf
                ...
                <button type="submit" id="login" class="block w-full bg-green-600 mt-4 py-2 rounded-2xl text-white font-semibold mb-2 hover:bg-green-400">Login</button>
            </form>
        </div>
    </div>
