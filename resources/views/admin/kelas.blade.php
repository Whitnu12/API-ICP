                            ...
                            <div class=" p-4 w-full">
                                ...
                                <form id="tambahKelas">
                                    ...
                                    <div class="my-2">
                                        ...
                                        <input type="text" id="jumlah_murid" name="jumlah_murid"
                                            class="shadow appearance-none border-none rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                                    </div>
                                    <div class="my-2">
                                        <label for="jurusan"
                        ...
                        <div class="hidden p-4 rounded-lg bg-white" id="dashboard" role="tabpanel"
                            ...
                            <div class="  p-4 w-full">
                                ...
                                <form id="rubahKelas">
                                    ...
                                    <div class="my-2">
                                        <label for="nama_kelas2">Kelas </label>
                                        <input type="text" id="nama_kelas2" name="nama_kelas"
                                            class="shadow appearance-none border-none rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                                    </div>
                                    <div class="my-2">
                                        <label for="jumlah_murid2">Jumlah Murid</label>
                                        <input type="text" id="jumlah_murid2" name="jumlah_murid"
                                            class="shadow appearance-none border-none rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                                    </div>
                                    <div class="my-2">
                                        <label for="jurusan2"
                                    ...
                                    <div class="my-2">
                                        ...
                                        <select name="angkatan" id="tahunDropdown2" style="width: 100%;">
                                            <option value="null">Pilih Angkatan</option>
                                        </select>
                                    </div>
                                    <button type="submit" class="bg-gray-300 px-10 py-2 mt-4 block">Tambah</button>
